        ...
        <div className="rounded-2xl border border-sky-200 bg-white p-4">
          ...
          <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {files.map((name) => (
              <div
                key={name}
                className="group flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-800"
              >
          ...
          <p className="mt-3 text-[11px] text-slate-500">
            *Nama file ditampilkan agar kamu jelas apa saja yang didapat. Detail
            halaman mengikuti file produk.
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="mt-4 space-y-3 text-sm">
            ...
            <div
              className={[
                ...
                bumpSelected && selectedPlan
                  ? "border-emerald-200 bg-emerald-50"
                  : "border-slate-200 bg-white",
                !selectedPlan ? "opacity-60" : "",
              ].join(" ")}
            >
              <label
                className={[
              ...
              >
                <input
                  type="checkbox"
                  checked={selectedPlan ? bumpSelected : false}
                ...
                <div className="min-w-0">
                  <p className="text-sm font-extrabold text-slate-900">
                    Tambahan (opsional) - Worksheet ekstra
                    <span className="ml-2 inline-flex items-center rounded-full bg-slate-900/5 px-2 py-0.5 text-[11px] font-semibold text-slate-700 ring-1 ring-slate-200">
                      boleh skip
                    </span>
                  </p>
                  <p className="mt-1 text-xs text-slate-600">
                    Cocok kalau kamu ingin stok aktivitas lebih banyak untuk
                  ...
                  <ul className="mt-3 space-y-2 text-sm text-slate-700">
                    <li className="flex items-start gap-2">
                      <span className="mt-[2px]">✅</span>
                      <span>File tambahan (PDF siap cetak)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-[2px]">✅</span>
                      <span>Langsung bisa diunduh setelah bayar</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-[2px]">✅</span>
                      <span>Print ulang seumur hidup</span>
                    </li>
                  </ul>
                </div>
