...
“1000 Lembar Printable Anak Muslim”.
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <button
                onClick={onPrimary}
                className="inline-flex h-12 items-center justify-center rounded-full bg-emerald-600 px-6 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-700 active:scale-[0.98]"
              >
